...
//    }
    ...
    @Test
    void reverseWords() {
        assertEquals("word",twoPtrObj.reverseWords("word"));
...
//        assertArrayEquals(new int[]{4, 1, 4, 3, 0, 3}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{1,4,4,3,0,3}));
//        assertArrayEquals(new int[]{4,5,2,7}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{4,2,5,7}));
//        assertArrayEquals(new int[]{6,9,2,5}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{9,2,5,6}));
//        assertArrayEquals(new int[]{2,9,4,1}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{9,2,4,1}));
        assertArrayEquals(new int[]{0, 1, 0, 1, 6, 7}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{0,1,1,0,6,7}));
        assertArrayEquals(new int[]{4, 1, 4, 3, 0, 3}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{1,4,4,3,0,3}));
        assertArrayEquals(new int[]{4, 1, 4, 3, 0, 3}, twoPtrObj.arrangeNumbersAccordingToIdx(new int[]{1,4,4,3,0,3}));
